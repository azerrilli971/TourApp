    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            holder.mInfoMenu.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    PopupMenu popup = new PopupMenu(PizzeriaListActivity.this, view);
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            switch (item.getItemId()) {
                                case R.id.menuModifica:
                                    ...
                                    Intent i = new Intent(PizzeriaListActivity.this, CustomListActivity.class);
                                    String[] testi = {"Pizzerie","Nome Pizzeria", "Descrizione Pizzeria", "Via Pizzeria", "Orari Pizzeria"};
                                    String[] valori = {mValues.get(position).nomePizzeria, mValues.get(position).dettagliPizzeria, mValues.get(position).viaPizzeria, mValues.get(position).orariPizzeria, mValues.get(position).id};
                                    i.putExtra("Testi", testi);
                                ...
                                case R.id.menuElimina:
                                    ...
                                    ref.child("Pizzerie").child(mValues.get(position).id).removeValue(new DatabaseReference.CompletionListener() {
                                        @Override
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            TextView mNomePizzeria;
            TextView mViaPizzeria;
            TextView mOrariPizzeria;
            ImageView mImmaginePizzeria;
            ImageView mInfoMenu;
