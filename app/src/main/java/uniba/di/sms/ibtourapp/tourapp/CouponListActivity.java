...
public class CouponListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(CouponListActivity.this, CustomListActivity.class);
                String[] testi = {"Coupons","Codice Coupon"};
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final CouponListActivity mParentActivity;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(CouponDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(CouponDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(CouponListActivity parent,
