...
public class RestaurantDetailFragment extends Fragment {
     ...
     */
    private Ristoranti.DummyItem mItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            mItem = Ristoranti.ITEM_MAP.get(getArguments().getString(ARG_ITEM_ID));

            Activity activity = this.getActivity();
            CollapsingToolbarLayout appBarLayout = (CollapsingToolbarLayout) activity.findViewById(R.id.toolbar_layout);
            if (appBarLayout != null) {
                appBarLayout.setTitle(mItem.nomeRistorante);
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            if( Locale.getDefault().getLanguage() != "it" ) {
                mItem.setDettagliRistorante(Translate.Translate(mItem.dettagliRistorante, "it-"+ Locale.getDefault().getLanguage(), getContext()));
            }
            ((TextView) rootView.findViewById(R.id.restaurant_detail)).setText(mItem.dettagliRistorante);
        }
